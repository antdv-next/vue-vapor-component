...
<template>
  <button type="button" role="switch" ref="btn" :class="switchClassName" :aria-checked="checked || defaultChecked" :disabled="disabled" @keydown="onInternalKeydown" @click="onInternalClick">
