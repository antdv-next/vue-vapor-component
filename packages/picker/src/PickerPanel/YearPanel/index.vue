...
const baseDate = computed(() => generateConfig.value.addYear(startYearDate.value, -1))
...
<template>
  <div :class="panelPrefixCls">
    <PanelHeader
      :super-offset="(distance: number, date: any) => generateConfig.addYear(date, distance * 10)"
