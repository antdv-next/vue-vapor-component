...
<template>
  ...
  >
    ...
    <image
      v-if="imageSettings?.src && calcSettings"
      :href="imageSettings.src"
      :height="calcSettings.h"
      :width="calcSettings.w"
      :x="calcSettings.x + marginValue"
      :y="calcSettings.y + marginValue"
      preserveAspectRatio="none"
      :opacity="calcSettings.opacity"
