...
<template>
  <svg :height="size" :width="size" :viewBox="`0 0 ${numCells} ${numCells}`" role="img" ref="_svg">
    ...
    <image v-if="imageSettings?.src && calcSettings" :href="imageSettings.src" :height="calcSettings.h"
