  ...
  <div class="home">
    ...
    <div class="content">
      ...
      <div class="card card-left">
        <h3 class="card-title">
          <svg class="card-icon" viewBox="0 0 16 16" fill="currentColor">
            <path
              d="M8.005 0a.5.5 0 0 1 .065.052L14.442 6.042a.5.5 0 0 1-.065.727l-1.11.868a.5.5 0 0 0-.134.444v2.793a.5.5 0 0 1-.5.5H7.807a.5.5 0 0 1-.5-.5v-1.44a.5.5 0 0 0-.149-.354L3.917 10.5a.5.5 0 0 1-.814-.386V7.105a.5.5 0 0 0-.134-.444l-1.11-.868a.5.5 0 0 1-.065-.727L5.935.052A.5.5 0 0 1 6 0h2.005Zm2.39 7.703a.5.5 0 1 1 1 .002.5.5 0 0 1-1 0Z"
            />
          </svg>
          混合模式优势
        </h3>
